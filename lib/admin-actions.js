...
export async function createProduct(prevState, formData) {
  ...
  const { name, slug, description, shortDescription, specifications, brand, productCode, price, discountedPrice, stock, categoryId, isTrending, images } = validatedFields.data
